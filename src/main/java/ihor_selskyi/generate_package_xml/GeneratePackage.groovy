...
// #### MAIN ####
def (configFile, srcDirName, packageFileName, version) = parseArgs(args)
def packageTemplate = '''
...
packageXml.version[0].value = version
...
def parseArgs(def args) {
	def configFile, srcDir, packageFile, version
...
//	}
	...
	version = args[3]
	[configFile, srcDir, packageFile, version]
}
